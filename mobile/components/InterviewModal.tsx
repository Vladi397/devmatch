...
function TypeBadge({ type }: { type: Question["type"] }) {
  ...
  return (
    <View style={[{ borderRadius: Radius.full, borderWidth: 1, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: color + "22", borderColor: color + "55" }]}>
      <Text style={[{ fontSize: 11, fontWeight: "700", letterSpacing: 0.3, color }]}>{label}</Text>
    </View>
  );
}
...
function makeStyles(Colors: ColorPalette) {
  return StyleSheet.create({
    ...
    progressPill: {
      ...
      borderWidth: 1, borderColor: Colors.border, paddingHorizontal: 12, paddingVertical: 5,
    },
    ...
    summaryHeading: { fontSize: 22, fontWeight: "800", color: Colors.textPrimary, textAlign: "center" },
